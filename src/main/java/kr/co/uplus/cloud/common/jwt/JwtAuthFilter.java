...
import static kr.co.uplus.cloud.common.config.SecurityConfig.LOGIN_API_URL;
import static kr.co.uplus.cloud.common.config.SecurityConfig.PUBLIC_API_URL;
...
public abstract class JwtAuthFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		if (WebUtils.isResourceRequest(request)
				|| WebUtils.isMatchedUriPattern(request, PUBLIC_API_URL, LOGIN_API_URL)) {
