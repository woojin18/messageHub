package kr.co.uplus.cloud.sample.dao;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Repository;

import kr.co.uplus.cloud.sample.consts.DB;
...
public class AuthUserDao extends InnerMsg {
	...
	public AuthUser getByUsername(String username) {
		...
		if (authUser == null) setErrMsg(sqlSession.getErrMsg());
	...
	public int setAuthUserRegister(AuthUser user) {
		...
		if (n_res < 0) setErrMsg(sqlSession.getErrMsg());
