...
import kr.co.uplus.cloud.sample.filter.VueStaticFilter;
import kr.co.uplus.cloud.sample.handler.LoginFailureHandler;
import kr.co.uplus.cloud.sample.handler.LoginSuccessHandler;
import kr.co.uplus.cloud.sample.jwt.JwtAuthCookieFilter;
import kr.co.uplus.cloud.sample.jwt.JwtAuthHeaderFilter;
import kr.co.uplus.cloud.sample.jwt.JwtExceptionFilter;
import kr.co.uplus.cloud.sample.jwt.JwtProperties;
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.authorizeRequests()
				...
				.antMatchers("/", PUBLIC_API_URL, LOGIN_FORM_URL, LOGIN_API_URL, SAMPLE_API_URL, LOGOUT_URL, LIST_API_URL, PROJECT_API_URL).permitAll()
