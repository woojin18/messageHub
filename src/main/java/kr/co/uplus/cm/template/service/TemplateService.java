...
public class TemplateService {
    ...
    public RestResult<Object> procApprvRequestKkoTmplt(AlimTalkTmpltRequestData requestData, Map<String, Object> params, MultipartFile files) throws Exception {
        ...
        if(!StringUtils.equals(ApiConfig.GW_API_SUCCESS, rsltCode)) {
            rtn.setFail(CommonUtils.getGWApiFailMsg(responseBody, "알림톡 템플릿 등록요청에 실패하였습니다."));
    ...
    public RestResult<Object> procInspectRequestKkoTmplt(Map<String, Object> params) throws Exception {
        ...
        if(!StringUtils.equals(ApiConfig.GW_API_SUCCESS, rtltCode)) {
            rtn.setFail(CommonUtils.getGWApiFailMsg(responseBody, "알림톡 템플릿 검수요청에 실패하였습니다."));
    ...
    public RestResult<Object> procUpdateRequestKkoTmplt(AlimTalkTmpltRequestData requestData, Map<String, Object> params, MultipartFile files) throws Exception {
        ...
        if(!StringUtils.equals(ApiConfig.GW_API_SUCCESS, rtltCode)) {
            rtn.setFail(CommonUtils.getGWApiFailMsg(responseBody, "알림톡 템플릿 수정요청에 실패하였습니다."));
