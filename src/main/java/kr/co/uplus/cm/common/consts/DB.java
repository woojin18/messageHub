...
public class DB {
    ...
    public final static String QRY_SELECT_IMAGE_UPLOAD_SET = "common.selectImageUploadSet";
    public final static String QRY_SELECT_EXCEL_UPLOAD_SET = "common.selectExcelUploadSet";
