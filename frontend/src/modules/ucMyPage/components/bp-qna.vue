<template>
	<div class="modal modalStyle in" id="ucQnaPopup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
export default {
  ...
  methods: {
      ...
      fnDataReset(){
        ...
        this.hpNumber = this.memberInfo.hpNumber;    // 신규 문의 사항인 경우 로그인 회원의 전화번호
        this.email = this.memberInfo.loginId;           // 신규 문의 사항인 경우 로그인 회원의 이메일
