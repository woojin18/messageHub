...
-->				            
				...
				<div class="phone_04_btn6">
					<div class="of_h consolMarginTop">
						<div class="float-left" style="width:33%" v-for="(channel, index) in rowData.channelButtonArray" :key="channel">
		...
		<div class="of_h inline-block vertical-top consoleCon" style="width:60%">
			...
			<div class="mt20 float-right">
				...
				<router-link :to="{ name: 'smartSend' }" tag="a" class="btnStyle2 float-left">목록</router-link>
			</div>
		</div>			
	</div>
...
<script>
import smartSendApi from "@/modules/smartSend/service/smartSendApi.js";
...
//      }
    ...
    async fnExcelTmplteDownLoad(){
      ...
      await smartSendApi.excelDownSendIntegratedRecvTmplt(params);
    },
