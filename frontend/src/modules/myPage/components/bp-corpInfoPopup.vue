					...
					<div class="of_h">
						...
						<div class="border-line mt20 Dashboard06">
							<div class="of_h">
								...
								<h5 style="width:80%" class="float-right">{{ regno }}</h5>
							</div>	
						
							<div class="of_h consolMarginTop">
								<h5 class="inline-block" style="width:20%">사업자명 <span class="color1">*</span></h5>
								<input type="text" class="inputStyle float-right" style="width:80%" title="사업자명 입력란" v-model="corpName">
							</div>	
							<div class="of_h consolMarginTop">
							...
							<div class="of_h consolMarginTop">
								...
								<input type="text" class="inputStyle" style="width:31%" title="업태 입력란"  v-model="busitype">
								<h5 class="inline-block ml20" style="width:10%">종목 <span class="color1">*</span></h5>
								<input type="text" class="inputStyle float-right" style="width:31%" title="종목 입력란" v-model="busiclass">
							</div>	
							<div class="of_h consolMarginTop">
								<h5 class="inline-block" style="width:20%">사업장주소 <span class="color1">*</span></h5>
								<input type="text" class="inputStyle" style="width:58%" title="사업장주소 입력란"  v-model="woplaceAddress">
							...
							<div class="of_h consolMarginTop">
								...
								<input type="text" class="inputStyle" style="width:37%" title="사업자등록증 입력란">
								<a @click="fnUploadCorpImg"  class="btnStyle1 backLightGray ml15" title="파일첨부">파일첨부</a>
                <a @click="fnDownloadCorpImg" class="btnStyle1 backLightGray float-right" title="다운로드">다운로드</a>
