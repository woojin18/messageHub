			...
			<div class="col-xs-12 consolMarginTop">
				<div class="of_h inline">
					<div class="float-right">
						<router-link :to="{ name: 'smartTemplateManage', params:{'productCodeP': productCode} }" tag="a" class="btnStyle2 borderGray" v-show="checkSmartProduct" activity="SAVE">템플릿 등록<i class="fal fa-arrow-to-bottom" ></i></router-link>
