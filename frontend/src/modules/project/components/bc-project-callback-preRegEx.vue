    ...
    <article v-if="!preRegYn">
		...
		<div class="row bgColor_f1 row-no-margin mt10">
			...
			<div class="col-xs-6">					
				<div class="of_h pd20">
					<p class="color4">
						[제출서류]<br>&nbsp;&nbsp; - 자체 발신번호 시스템 구축 사실 공문 1부<a @click="fnReg('system')"  class="btnStyle1 borderLightGray small mr5 ml10">다운로드 </a>
					</p>
					<p class="color4 consolMarginTop">
						&nbsp;&nbsp; - 발신번호 사전등록 시스템 설계화면<a @click="fnReg('system')"  class="btnStyle1 borderLightGray small mr5 ml10">다운로드 </a>
					</p>
					<p class="color4 consolMarginTop">
						&nbsp;&nbsp; - 발신번호 사전등록 화면<a @click="fnReg('system')"  class="btnStyle1 borderLightGray small mr5 ml10">다운로드 </a>
					</p>
					<p class="color4 consolMarginTop">
						&nbsp;&nbsp; - 미등록 발신번호 차단처리 화면<a @click="fnReg('system')"  class="btnStyle1 borderLightGray small mr5 ml10">다운로드 </a>
					</p>	
				</div>
			</div>	
		...
		<div class="row bgColor_f1 row-no-margin mt10">
			...
			<div class="col-xs-6">					
				<div class="of_h pd20">
					...
					<p class="color4 consolMarginTop">- 중앙전파관리소로부터 특수부가통신사업자로 등록 완료된 리스트를 전달받아 등록 처리됨.<br>&nbsp;&nbsp; 단, 정기적으로 전달되지 않으므로 당사 홈페이지에서 예외사업자로 적용되었는지 반드시 확인 필요</p>
					<p class="color4 consolMarginTop">[제출서류]<br>- 특수부가통신사업자 등록증 1부<a @click="fnReg('special')" class="btnStyle1 borderLightGray small mr5 ml10">다운로드 </a></p>	
				</div>
			</div>	
