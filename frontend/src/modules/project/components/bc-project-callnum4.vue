<template>
  <div>
    ...
    <article v-if="!preRegYn">
		<div class="clear">
			<h4 class="inline-block">문자 사전등록 예외 사업자로 대상</h4>	
		</div>
		<div class="row bgColor_f1 row-no-margin consolMarginTop">
			<div class="col-xs-3" style="border-right:1px solid #fff">
				<h5 class="ml30 line-height1-5em topH4" style="padding:20% 0">위법한 문자를 발송한 적이<br>없는 사업자<br>(스팸 문자 미발송 사업자)</h5>
			</div>
			<div class="col-xs-6">					
				<div class="of_h pd20">
		...
		<div class="row bgColor_f1 row-no-margin mt10">
			<div class="col-xs-3" style="border-right:1px solid #fff">
				<h5 class="ml30 line-height1-5em topH4" style="padding:20% 0">발신번호 사전등록<br>시스템을 갖춘 사업자</h5>
			</div>
			<div class="col-xs-6">					
				<div class="of_h pd20">
					<p class="color4">
		...
		<div class="row bgColor_f1 row-no-margin mt10">
			<div class="col-xs-3" style="border-right:1px solid #fff">
				<h5 class="ml30 topH4" style="padding:24% 0">공공기관</h5>
			</div>
			<div class="col-xs-6">					
				<div class="of_h pd20">
		...
		<div class="row bgColor_f1 row-no-margin mt10">
			<div class="col-xs-3" style="border-right:1px solid #fff">
				<h5 class="ml30 topH4" style="padding:31% 0">특수부가통신사업자</h5>
			</div>
			<div class="col-xs-6">					
				<div class="of_h pd20">
