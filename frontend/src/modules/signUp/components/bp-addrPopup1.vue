<template>
<div class="modal modalStyle in" id="addrPopup1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<div>
                        ...
                        <div class="of_h consolMarginTop mt20">
                            <div class="text-center">
                                <button @click="fnCloseLayer" class="btnStyle1 backWhite ml10" title="닫기">닫기</button>
                            </div>
                        </div>
