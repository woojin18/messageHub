        ...
        <div class="modal-body">
          <div class="of_h">
            ...
            <div class="float-right" style="width:79%">
              <input type="text" class="inputStyle" title="제목 입력란" v-model="sendData.pushTitle" maxlength="45">
            </div>
          </div>
          <div class="of_h mt15">
            <div class="float-left" style="width:20%"><h4 class="font-normal font-size14 mt15">내용 *</h4></div>
            <div class="float-right" style="width:79%">
              <textarea class="textareaStyle height120" placeholder="" v-model="sendData.pushContent" maxlength="512"></textarea>
            </div>
            <div v-if="sendData.msgKind == 'A'">
              ...
              <div class="float-right mt10" style="width:79%">
                <input type="text" class="inputStyle" title="내용 입력란" placeholder="" v-model="sendData.rcvblcNumber">
              </div>
          ...
          <div class="of_h mt15">
            ...
            <div class="float-right" style="width:79%">
              <input type="text" class="inputStyle" title="부가정보(EXT) 입력란" v-model="sendData.adtnInfo" maxlength="45">
            </div>
          </div>
          <div class="text-center mt60">
            <a href="#self" class="btnStyle3 black font14" title="입력">입력</a>
